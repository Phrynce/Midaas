...
<div className=' flex justify-center items-center text-black lg:text-[25px] text-[17px] pt-3 font-serif font-semibold'>Art Programmes</div>
<div className=' flex justify-center items-center lg:w-[400px] mx-10 h-[1px] bg-black mb-4'></div>
<div className=' flex justify-start mx-10 items-center text-[17px] font-normal font-mono text-black pb-2'>Design</div>
<div className=' flex justify-start mx-10 items-center text-[17px] font-normal font-mono text-black pb-2'>Music</div>
<div className=' flex justify-start mx-10 items-center text-[17px] font-normal font-mono text-black pb-2'>Music (Instrument Performance Piano)</div>
<div className=' flex justify-start mx-10 items-center text-[17px] font-normal font-mono text-black pb-2'>Digital media art</div>
<div className=' flex justify-start mx-10 items-center text-[17px] font-normal font-mono text-black pb-2'>Music And Dance</div>
