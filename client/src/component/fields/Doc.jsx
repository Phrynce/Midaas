...
const Doc = () => {
  ...
  <div className='container '>
      ...
      <div className=' text-[85px] font-normal lg:w-[500px] w-[300px] bg-white/55 rounded-lg'>
<div className=' flex justify-center items-center text-black lg:text-[25px] text-[17px] pt-3 font-serif font-semibold'>Doctoral Requirement</div>
<div className=' flex justify-center items-center lg:w-[400px] w-[220px] mx-10 h-[1px] bg-black mb-4'></div>
